...
class CircleSliderViewController: UIViewController, TopBarsAppearanceChangable {
...
fileprivate extension CircleSliderViewController {
    
    func setupCircleSlider() {
        circleSlider.thumbImage = #imageLiteral(resourceName: "circleslider_thumb")
    ...
    func setupUISlider() {
        ...
        [minValueSlider, maxValueSlider, startAngleSlider, circumAngleSlider, radiusSlider, lineWidthSlider, startColorRSlider, startColorGSlider, startColorBSlider, symmetryRSlider, symmetryGSlider, symmetryBSlider].forEach {
            $0?.setThumbImage(#imageLiteral(resourceName: "circleslider_thumb"), for: .normal)
        }
    }
